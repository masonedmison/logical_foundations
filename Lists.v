...
Theorem add_inc_count : forall (n: nat) (nl: natlist),
  count n (add n nl) = (count n nl) + 1.

(* TODO not sure why this doesn't simplify? *)
Proof.
  intros n nl.
  simpl.
  rewrite eqb_refl.
...
(* good example of getting unstuck *)
...
Fixpoint eqblist (l1 l2 : natlist) : bool :=
  ...
  | _, nil => false
  | lh :: lt, rh :: rt =>
    if eqb lh rh then eqblist lt rt
    else false
  end.
