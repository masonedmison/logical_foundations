...
(* Lemma mult_k_plus_1 : forall n k : nat,
...
(* FILL IN HERE *)
Example filter_leading_zeros : normalize (B0 (B0 (B1 (B0 ( B0 Z))))) = B0 (B0 (B1 Z)).
Proof.
  simpl. reflexivity. Qed.

Example filter_leading_zeros_w_zero : normalize (B0 (B0 (B0 ( B0 Z)))) = Z.
Proof.
  simpl. reflexivity. Qed.
...
(* Lemma relate_doubles : forall b,
  nat_to_bin (double (bin_to_nat b)) = nat_to_bin (bin_to_nat (double_bin b)).
Proof.
  intros b.
  induction b as [| n' IHn'| m' IHm'].
  - simpl. reflexivity.
...
Lemma normalize_inner_b : forall b,
